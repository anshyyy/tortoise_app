...
class InnerShadowBoxDecoration extends Decoration implements BoxDecoration {
  ...
  static InnerShadowBoxDecoration? lerp(
      InnerShadowBoxDecoration? a, InnerShadowBoxDecoration? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    if (a == null) {
...
class _InnerShadowBoxDecorationPainter extends BoxPainter {
  _InnerShadowBoxDecorationPainter(this._decoration, VoidCallback? onChanged) : super(onChanged);
    ...
    switch (_decoration.shape) {
      ...
      case BoxShape.rectangle:
        if (_decoration.borderRadius == null) {
          ...
          final borderRadius =
              _decoration.borderRadius!.add(BorderRadius.circular(addBorderRadius));
  ...
  void _paintShadows(Canvas canvas, Rect rect, TextDirection? textDirection) {
    ...
    for (final BoxShadow boxShadow in _decoration.boxShadow!) {
      ...
      _paintBox(canvas, bounds, paint, textDirection, addBorderRadius: boxShadow.spreadRadius);
    }
  }
  ...
  void _paintInnerShadows(Canvas canvas, Rect rect, TextDirection? textDirection) {
    ...
    for (final BoxShadow shadow in _decoration.innerBoxShadow!) {
      ...
      if (_decoration.borderRadius != null) {
        var rrect = _decoration.borderRadius!
        ...
        final innerRect = rrect.shift(shadow.offset).deflate(shadow.spreadRadius);
        ...
        final innerRect = rect.shift(shadow.offset).deflate(shadow.spreadRadius);
        final path = Path.combine(
          PathOperation.difference,
          Path()..addRect(rect),
